<script lang="ts">
  ...
  import { Plus, Trash2, Edit, Users, Mail, Building2, Phone } from 'lucide-svelte';
  ...
  async function updateUser() {
    if (!editingUser.first_name || !editingUser.last_name || !editingUser.email || !editingUser.phone) {
      toast.error('Please fill in all required fields');
      return;
    }
...
<div class="flex h-screen bg-[#eceef3]">
  <Sidenav activePage="viewroom-users" />
