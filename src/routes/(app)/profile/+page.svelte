      ...
      <main class="flex-1 overflow-y-auto p-6">
        <div class="container mx-auto p-4 min-h-screen">
            ...
            <div class="profile-info flex flex-col items-center p-4 bg-gray-100 rounded-lg shadow-md my-8">
                <img src={user.avatar ? `${data.avatarUrl}` : `https://ui-avatars.com/api/?name=${user.name}?background=random`} alt="User Avatar" class="w-24 h-24 rounded-full mb-4 object-cover object-center">
